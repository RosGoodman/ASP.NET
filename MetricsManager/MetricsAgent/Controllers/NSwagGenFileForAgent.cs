...
namespace MyNamespace
{
    ...
    public partial interface IClient
    {
        ...
        System.Threading.Tasks.Task ApiMetricsCpuGreetingAsync();

        /// <summary>Приветствие. Простой зарос для проверки подключения.</summary>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        void ApiMetricsCpuGreeting();

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Приветствие. Простой зарос для проверки подключения.</summary>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task ApiMetricsCpuGreetingAsync(System.Threading.CancellationToken cancellationToken);
    ...
    public partial class Client : IClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task ApiMetricsCpuGreetingAsync()
        {
            return ApiMetricsCpuGreetingAsync(System.Threading.CancellationToken.None);
        }

        /// <summary>Приветствие. Простой зарос для проверки подключения.</summary>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public void ApiMetricsCpuGreeting()
        {
            System.Threading.Tasks.Task.Run(async () => await ApiMetricsCpuGreetingAsync(System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task ApiMetricsCpuGreetingAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/metrics/cpu/greeting");
